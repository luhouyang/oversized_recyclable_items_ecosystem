                      ...
                      children: [
                          ...
                          children: [
                            OutlinedButton.icon(
                              ...
                              style: OutlinedButton.styleFrom(
                                side: BorderSide(color: UIColor().primaryColorLight),
                                foregroundColor: UIColor().primaryColorLight,
                              ),
                            )
                          ],
                        ),
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: UIColor().white, width: 3),
                                ),
                                child: Text(
                                  "Lvl",
                                  style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                "${userData.points} Eco-Points Earned",
                                style: TextStyle(color: UIColor().gray, fontSize: 14, fontWeight: FontWeight.bold),
                              ),
                            ],
                          ),
                        ),
                        ...
                        Wrap(
                          ...
                          children: [
                            if (userData.contact['whatsapp'] != null &&
                              ...
                              Chip(
                                label: const Text("WhatsApp connected",
                                    style: TextStyle(
                                        color: Color(0xFF075E54),
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13)),
                                avatar: const Icon(Icons.phone_android, size: 18, color: Color(0xFF25D366)),
                            ...
                            if (userData.contact['telegram'] != null &&
                              ...
                              Chip(
                                label: const Text("Telegram connected",
                                    style: TextStyle(
                                        color: Color(0xFF0088cc),
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13)),
                                avatar: const Icon(Icons.send, size: 18, color: Color(0xFF0088cc)),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              _buildStatBox(context, Icons.inventory_2, "Items Listed", "${userData.points ~/ 10}"),
                              _buildStatBox(context, Icons.recycling, "Items Recycled", "${userData.points ~/ 50}"),
                              _buildStatBox(context, Icons.cloud, "Est. CO2 Saved",
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: UIColor().gray.withOpacity(0.1),
                blurRadius: 8,
                offset: const Offset(0, 4)
              )
            ]
          ),
          child: Icon(icon, color: UIColor().primaryColorLight, size: 32),
        ),
        const SizedBox(height: 12),
        Text(
          value,
