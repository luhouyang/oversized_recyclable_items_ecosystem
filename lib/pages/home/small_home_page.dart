...
class _SmallHomePageState extends State<SmallHomePage> {
      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            Expanded(
              child: Text(
                date == null ? "Expiry Date" : DateFormat('yyyy-MM-dd HH:mm').format(date),
                style: TextStyle(
  ...
  // --- AI Logic ---
  void _magicWrite(
      TextEditingController nameCtrl, TextEditingController descCtrl, TextEditingController priceCtrl) {
  ...
  Future<void> _autoPriceItem(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (context.mounted) {
          SnackBarText().showBanner(msg: "AI Pricing failed. Please try again.", context: context);
        }
      }
    } catch (e) {
      if (context.mounted) Navigator.pop(context);
      debugPrint("Error: $e");
      if (context.mounted) {
        SnackBarText().showBanner(msg: "Error connecting to AI Agent.", context: context);
      }
    }
  }

  // --- Add/Edit Item Dialog (Mobile Optimized) ---
  void _showItemDialog(BuildContext context, {ItemEntity? existingItem}) {
    ...
    final TextEditingController priceController =
        TextEditingController(text: existingItem?.sellerPrice.toString() ?? '');
                        ...
                        if (!isEditing)
                          Padding(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: () => _autoPriceItem(
                                  nameController, descController, priceController, selectedCondition, imageData),
                              style: ElevatedButton.styleFrom(
                      ...
                      children: [
                        Expanded(
                          child: _buildDatePickerButton(
                              ...
                              onTap: () async {
                                await _selectDate(context, selectedExpiryDate ?? DateTime.now(), (val) {
                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              ...
                              icon: Icon(Icons.map, color: UIColor().primaryColorLight, size: 18),
                              label: Text(
                                selectedLocation == null ? "Pickup Loc" : "Location Set",
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(color: UIColor().primaryColorLight, fontSize: 12),
                              ),
                        ...
                        onPressed: isLoading
                            ...
                            : () async {
                                if (nameController.text.isEmpty || priceController.text.isEmpty) {
                                  SnackBarText()
                                      .showBanner(msg: "Please fill name and price", context: context);
                                  return;
                                }

                                if (!isEditing && imageData.imageBytes.length <= 1) {
                                  SnackBarText()
                                      .showBanner(msg: "Please select an image", context: context);
                                  return;
                                }
                                ...
                                try {
                                  ...
                                  if (imageData.imageBytes.length > 1) {
                                    imageUrl =
                                        await _storageService.uploadImage(imageData.imageBytes, "items");
                                  }
                                  ...
                                  if (isEditing) {
                                    ...
                                    if (context.mounted) {
                                      ...
                                      SnackBarText().showBanner(
                                          msg: "Item Added! +10 Eco-Points!", context: context);
                                      return;
                                    }
                                  }
                                  ...
                                  if (context.mounted) {
                                    SnackBarText().showBanner(msg: "Error: $e", context: context);
                                  }
                                } finally {
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            Text(
                              "Login via Profile Page to manage items",
                                          ...
                                          Positioned(
                                            ...
                                            child: IconButton(
                                              ...
                                              style: IconButton.styleFrom(
                                                  backgroundColor: Colors.black54, padding: const EdgeInsets.all(4)),
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text("RM ${item.sellerPrice.toStringAsFixed(0)}",
                                                style: TextStyle(
